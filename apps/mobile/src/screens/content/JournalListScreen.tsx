...
export default function JournalListScreen({ navigation }: any) {
  ...
  const load = async () => {
    try {
      const res = await getContentPosts("journal");
    ...
    <View style={styles.page}>
      ...
      >
        <View style={styles.hero}>
          ...
          <Text style={styles.heroTitle}>Journal Library</Text>
          <Text style={styles.heroText}>
            Read free and premium journals from ISKCON Ahmedabad.
          </Text>
        </View>

        <View style={styles.filterCard}>
          <View style={styles.filterRow}>
            <FilterButton label="All Issues" active={filter === "all"} onPress={() => setFilter("all")} />
            <FilterButton label="Free" active={filter === "free"} onPress={() => setFilter("free")} />
            <FilterButton label="Premium" active={filter === "paid"} onPress={() => setFilter("paid")} />
          </View>
        ...
        {filteredPosts.length === 0 ? (
          <View style={styles.emptyCard}>
            <Text style={styles.emptyTitle}>No Journal found</Text>
        ...
        <View style={styles.premiumCard}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.premiumTitle}>Unlock all premium Journal</Text>
...
function JournalCard({ post, onPress }: { post: any; onPress: () => void }) {
  ...
  const readingTime = Math.max(
    1,
    Math.ceil(stripHtml(post.content || "").split(/\s+/).filter(Boolean).length / 200)
  );
  ...
  return (
    <Pressable
      style={[styles.card, isPaid ? styles.paidCardBorder : styles.freeCardBorder]}
      onPress={onPress}
    >
      <View style={styles.imageWrap}>
        ...
        <View style={styles.topBadges}>
          <View style={isPaid ? styles.premiumBadge : styles.freeBadge}>
            ...
            <Text style={isPaid ? styles.premiumBadgeText : styles.freeBadgeText}>
              {isPaid ? "Premium" : "Free"}
            </Text>
          </View>
        ...
        <View style={styles.footerRow}>
          <View style={styles.authorRow}>
            <View style={isPaid ? styles.authorPaid : styles.authorFree}>
              <Text style={isPaid ? styles.authorPaidText : styles.authorFreeText}>
