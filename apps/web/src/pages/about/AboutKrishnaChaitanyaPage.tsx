...
export default function AboutKrishnaChaitanyaPage() {
  return (
    <>
      <PageSeo
        title="About Glory of Krishna and Chaitanya mahaprabhu | ISKCON Ahmedabad"
        description="Explore Glory of Krishna and Chaitanya mahaprabhu"
      />
            ...
            <aside className="space-y-6">
              <div className="overflow-hidden rounded-3xl border border-[#ede0c8] bg-white shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2 text-sm font-bold leading-7 text-[#9a7a4a]">
                    The golden incarnation of Lord Krishna who spread the
                    chanting of the holy names and the path of love of God.
                  </p>
                </div>
              </div>
            ...
            <main className="space-y-6">
              <Card title="Who is Lord Krishna?">
                <p>
                  ...
                  renunciation. He is not only the controller of the universe,
                  but also the most loving friend of every living being.
                </p>
                <p>
                  In bhakti-yoga, Krishna is approached not by fear, pride or
                  dry speculation, but by loving service. The heart becomes
                  purified when we hear about Krishna, chant His names, remember
                  His pastimes and serve Him with devotion.
                </p>
              ...
              <Card title="Who is Śrī Chaitanya Mahaprabhu?">
                <p>
                  ...
                  pure love of Krishna, through the simple and powerful process
                  of chanting the holy names. He did not reserve spiritual life
                  for a selected class of people. He opened the path of bhakti
                  for everyone.
                </p>
                <p>
              ...
              <section className="overflow-hidden rounded-3xl border border-[#ede0c8] bg-white p-7 shadow-sm">
                ...
                <p className="mt-5 text-[15px] font-medium leading-8 text-[#5c3d1a]">
                  ...
                  people are surrounded by anxiety. Chaitanya Mahaprabhu gave
                  the easiest and most merciful spiritual practice: chant the
                  names of Krishna with sincerity.
                </p>
              ...
              <Card title="Value of the Hare Krishna Mahā-Mantra">
                ...
                <p>
                  ...
                  chanting is not ordinary music or ritual. It is a personal
                  call to Krishna from the heart.
                </p>
                ...
                <div className="mt-6 rounded-3xl border border-[#ede0c8] bg-[#fff8ec] p-6 text-center">
                  <p className="font-serif text-3xl font-black leading-10 text-[#1a0a00]">
                    Chant with humility, hear with attention, and serve with
                    love.
                  </p>
                </div>
              </Card>
              ...
              <Card title="Why We Need a Spiritual Leader or Guru">
                ...
                <p>
                  Just as a student needs a qualified teacher to understand a
                  deep subject, a spiritual seeker needs guidance to understand
                  the science of the soul, Krishna, devotional service and the
              ...
              <Card title="The Path of Bhakti in Daily Life">
                <p>
                  ...
                  daily life through chanting, hearing, offering food to
                  Krishna, reading scripture, serving devotees, attending kirtan
                  and living with compassion.
                </p>
                <p>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-3">
                  ...
                  <Mini
                    title="Prasādam"
                    text="Honor food offered to Krishna."
                  />
                </div>
              </Card>
              ...
              <Card title="Why This Page Matters for Seekers">
                <p>
                  This page is for anyone who wants to understand why ISKCON
                  gives so much importance to Krishna, Chaitanya Mahaprabhu,
                  chanting, guru and devotee association. These are not separate
                  topics. Together they form the living path of Krishna
                  consciousness.
                </p>
                <p>
                  Krishna is the goal, Chaitanya Mahaprabhu gives the method,
                  the holy name purifies the heart, guru gives guidance, and
                  devotee association gives strength to continue.
                </p>
              </Card>
            </main>
          </div>
