  ...
  return (
    <div className="-mx-5 -my-8 bg-[#fdfaf5]">
      <section className="relative overflow-hidden bg-[#1a0a00] px-5 py-28 text-center">
        <div className="absolute inset-0 text-[320px] text-[#c8902a]/5">ॐ</div>
          ...
          <main className="space-y-6">
            <Card title="Early Life and Spiritual Calling">
              <p>
                ...
                From childhood he was drawn to devotion to Lord Krishna. In 1922
                he met his spiritual master, Śrīla Bhaktisiddhānta Sarasvatī
                Ṭhākura, who instructed him to spread the message of Krishna
                consciousness in the English language.
              </p>
            </Card>

            <Card title="Journey to the West">
              <p>
                In 1965, at the age of sixty-nine, Śrīla Prabhupāda travelled to
                America on the cargo ship Jaladuta. He carried little money, a
                trunk of books and deep faith in Krishna. His journey was not
                for personal comfort; it was an act of compassion for the world.
              </p>
            </Card>
            ...
            <section className="overflow-hidden rounded-3xl border border-[#ede0c8] bg-white p-7 shadow-sm">
              <div className="mb-5">
                ...
                <p className="mt-3 text-[15px] leading-8 text-[#5c3d1a]">
                  ...
                  Kolkata, his meeting with his spiritual master, the courageous
                  Jaladuta voyage, and the worldwide establishment of the Hare
                  Krishna movement.
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-bold leading-7 text-[#9a7a4a]">
                      ...
                      possessions, his books and complete faith in Krishna. This
                      historic journey transformed the spiritual lives of
                      millions worldwide.
                    </p>
                  </div>
                </div>
            ...
            <Card title="Founding ISKCON">
              <p>
                In 1966, Śrīla Prabhupāda founded the International Society for
                Krishna Consciousness in New York City. From a humble beginning,
                ISKCON grew into a worldwide spiritual movement centred on
                chanting the holy names, studying scripture, deity worship,
                prasādam distribution and devotional service.
              </p>
            </Card>

            <Card title="Books and Legacy">
              <p>
                Śrīla Prabhupāda translated and commented on major Vedic texts,
                including Bhagavad-gītā As It Is, Śrīmad Bhāgavatam and
            ...
            <Card title="Why Śrīla Prabhupāda Matters">
              <p>
                Śrīla Prabhupāda made ancient Vedic wisdom practical for modern
                people. He taught that spiritual life is not limited by country,
                caste, background or language. Anyone can begin by chanting,
                hearing, serving and accepting Krishna prasādam.
              </p>
              <p>
                His life shows determination, humility, scholarship and complete
                dependence on Krishna. For ISKCON Ahmedabad and the worldwide
                ISKCON family, he remains the founder-ācārya and guiding
                spiritual teacher.
              </p>
            </Card>
          </main>
