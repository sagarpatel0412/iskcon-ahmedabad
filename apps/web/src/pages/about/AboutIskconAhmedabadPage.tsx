...
export default function AboutIskconAhmedabadPage() {
  return (
    <>
      <PageSeo
        title="About Temple | ISKCON Ahmedabad"
        description="Explore about temple"
      />
        ...
        <section className="relative min-h-[700px] overflow-hidden bg-[#1a0a00] px-5 py-28 text-center">
          ...
          <div className="relative z-10 mx-auto max-w-5xl my-[30px]">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-lg font-bold leading-8 text-[#f5e8c8]">
              ...
              bhakti-yoga, kirtan, prasādam and the teachings of Śrīla
              Prabhupāda.
            </p>
          </div>
        </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_420px]">
            <main className="space-y-6">
              <Card title="A Spiritual Home for Everyone">
                <p>
                  ISKCON Ahmedabad welcomes seekers, families, students,
                  devotees and visitors who want to experience Krishna
                  consciousness in a practical and joyful way. The temple offers
                  darshan, kirtan, ārati, prasādam, festivals, study classes and
                  spiritual association.
                </p>
                <p>
                  The heart of the temple is loving service to Śrī Śrī Rādhā
                  Govinda. Through daily worship and community programs,
                  visitors are invited to slow down, hear the holy names, read
                  sacred wisdom and reconnect with their eternal relationship
                  with Krishna.
                </p>
              </Card>
              <section className="overflow-hidden rounded-3xl border border-[#ede0c8] bg-white p-6 shadow-sm">
                <div className="mb-5">
                  ...
                  <p className="mt-3 text-[15px] leading-8 text-[#5c3d1a]">
                    Experience the beauty of Śrī Śrī Rādhā Govinda Temple
                    through this guided virtual tour. Explore the magnificent
                    temple hall, altar, kirtan spaces and spiritual atmosphere
                    that thousands of devotees experience every year.
                  </p>
                </div>
                ...
                <div className="mt-5 rounded-2xl bg-[#fdfaf5] p-4">
                  <p className="text-sm font-bold leading-7 text-[#9a7a4a]">
                    ✨ Take a virtual walk through one of Gujarat's most
                    beautiful spiritual landmarks and discover the atmosphere of
                    devotion, kirtan, worship and community service that defines
                    ISKCON Ahmedabad.
                  </p>
                </div>
              </section>
              ...
              <Card title="Our Mission">
                <p>
                  The mission of ISKCON Ahmedabad is to share bhakti-yoga and
                  the teachings of Bhagavad-gītā and Śrīmad Bhāgavatam in a way
                  that is accessible to modern life. The temple helps people
                  cultivate devotion through chanting, hearing, service,
                  prasādam and association.
                </p>
              </Card>
